 ...
 * @details Default constructor for a Logger object that initializes the db connection.
 * @return Nothing.
 */
Logger::Logger()
{
 ...
 * @details Default destructor for a Logger object that closes the db connection.
 * @return Nothing.
 */
Logger::~Logger()
{
